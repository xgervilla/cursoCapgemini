...
//    private final String cifNumero = "ABEH";
    ...
    public boolean isValido(String nif) {
    	/*NIFs inválidos:
    	 * longitud no válida (menor de 8 en el caso de no haber letra, mayor de 9 en caso de haber letra
    	 * "caso base" (todo 0s + la T)
    	...
    	if ("00000000T".equals(nif)) return false;
    ...
    public boolean isNotValido(String nif) {
    	return !isValido(nif);
    }
